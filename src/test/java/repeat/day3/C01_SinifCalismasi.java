...
public class C01_SinifCalismasi {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //  c. email textbox,password textbox, and signin button elementlerini locate(yerini bulmak) ediniz..
        Thread.sleep(3000);
     ...
     WebElement signinButon= driver.findElement(By.name("commit"));
        ...
        }else System.out.println("ExpectedUser testi FAILED "+expectedUser.getText());
        // 2. yol
        ...
        if (signOut.isDisplayed()){
            System.out.println("Sign Out TESTİ PASSED");
        ...
        // linkleri LAMBDA ile yazdiriniz
